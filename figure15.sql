...
group by cont.name; -- (This will be set to specific value for each of the queries but for now is easier for us to just see all to verify original query works)
